...
export const DAO_CONTENT = {
  slides: [
    {
      ...
      description:
        'Every DEX aggregator will tell you they have the best prices, but at the end of the day, Planet Swap does everything they do and then some. With peer-to-peer order matching, gas optimization, and MEV protection, Planet Swap improves your quoted price and forwards the surplus back to you.',
    },
    {
      image: `${IMAGE_PATH}/dao-custom-tailor-orders.svg`,
      title: 'Stop scrambling for signatures',
      description:
        "Tired of rushing to sign the multi-sig? Eyes glazed over from staring at candlesticks? Planet Swap automatically adjusts your trade's execution path to fill your order at the best possible price, every time.",
    },
    {
      image: `${IMAGE_PATH}/dao-vote-once.svg`,
      title: 'Forget about voting twice ',
      description:
        "Milkman orders from Planet Swap let your DAO approve trades based on dynamic price feeds rather than fixed prices, so you don't have to re-vote if the market moves significantly.",
    },
    {
      image: `${IMAGE_PATH}/dao-outsmart-bots.svg`,
      title: 'Outsmart the bots',
      description:
        "Planet Swap offers MEV protection that is one order of magnitude better than any other exchange. Solvers execute trades on your behalf so you're never exposed to on-chain attacks – and even when trade details are announced weeks in advance, Planet Swap stands between you and the MEV bots.",
    },
    {
      image: `${IMAGE_PATH}/dao-manage-price-impact.svg`,
      title: 'Manage price impact',
      description:
        "Your trades move markets… but being the biggest isn't always the best. Planet Swap spreads your order across multiple liquidity pools so you make as little of a splash as possible.",
    },
    {
      image: `${IMAGE_PATH}/dao-do-more.svg`,
      title: 'Do anything you can imagine',
      description:
        'With Planet Swap you can customize rules for your orders above and beyond traditional settings. Want to trigger a trade only when a wallet has n funds in it? Want to schedule recurring trades? Planet Swap lets you do all that and more in just a few clicks.',
    },
  ],
  ...
  orderTypes: [
    ...
    },
    {
      ...
      title: 'Limit Orders',
      description:
        "Planet Swap's surplus-capturing limit orders allow you to set a price and sit back while your order gets filled over time - perfect for token buybacks and other large trades.",
    },
    {
      icon: `${IMAGE_PATH}/icon-price-walls.svg`,
      title: 'Price Walls',
      description:
        'Pick an asset, define a threshold price, and Planet Swap will automatically sell above the threshold, and buy below it.',
    },
    {
      ...
      description: (
        <>
          ...
          , a collaboration between Planet Swap and Yearn, allows DAOs and traders to sell multiple tokens in a single
          transaction.
        </>
      ),
    },
  ...
  trustedDAOs: [
    {
      ...
      title: 'Aave',
      description: 'Aave DAO used Planet Swap to swap over $4 million directly into Balancer liquidity pool',
    ...
    },
    {
      ...
      title: 'Nexus Mutual',
      description:
        'In the largest DAO trade ever, Nexus Mutual relied on Planet Swap to trade 14,400 ETH for the rETH liquid staking token',
    ...
    },
    {
      ...
      title: 'ENS',
      description: 'ENS DAO traded a whopping 10,000 of ETH ($16.5 million dollars) for USDC through Planet Swap',
