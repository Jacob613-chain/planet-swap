...
export const COW_IS_DIFFERENT = [
  {
    ...
    fontSize: 28,
    color: '#012F7A',
    description: "By aligning incentives between solvers and users, Planet Swap finds surplus you won't get anywhere else",
  ...
  },
  {
    ...
    fontSize: 28,
    color: '#CCF8FF',
    description: 'MEV is a $1.3+ billion problem that you never have to worry about on Planet Swap',
  ...
  },
  {
    ...
    fontSize: 28,
    color: '#012F7A',
    description: "Planet Swap's unique architecture enables advanced order types and seamless UX",
...
export const ADVANCED_ORDER_TYPES = [
  {
    ...
    description: 'Planet Swap market orders maximize surplus and minimize MEV',
  ...
  },
  {
    ...
    title: 'Limit orders',
    description:
      'Placing a limit order is like setting a trap for a price for your trade. Planet Swap is the only DEX that offers surplus on limit orders – and one of the only DEXs that offers limit orders at all',
...
export const FAQ_DATA = [
  {
    question: 'What is Planet Swap?',
    answer: (
      <>
        Planet Swap is a meta DEX aggregator that uses{' '}
        <Link
        ...
        (MEV). It is the first UI built on top of CoW Protocol. As the leading intents-based DEX, Planet Swap leverages a
        ...
        (CoWs) to settle the order. Planet Swap is the leader among intent-based trading protocols by transaction volume
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        liquidity from other aggregators as well as from individual DEXs. Planet Swap is a meta DEX aggregator because
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        of Wants. Thanks to Planet Swap's{' '}
        <Link
          href="https://docs.cow.fi/cow-protocol/concepts/introduction/batch-auctions"
          external
          utmContent="cow-protocol-introduction-batch-auctions"
  ...
  {
    question: 'How is Planet Swap better than other DEX aggregators?',
    answer: (
      <>
        Planet Swap’s unique architecture allows it to give users comprehensive MEV protection as well as better prices for
        their trades. While most other DEX aggregators simply compare quotes from various DEXs and execute orders
        against whichever DEX is lowest at the time of quoting, Planet Swap seeks to find the best execution price. Planet
        ...
        execution risk by settling the batches on their behalf. Planet Swap is unique among DEX aggregators as it is built
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        architecture, Planet Swap protects users from all types of malicious MEV.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        ...
        transactions directly onchain. However, Planet Swap’s unique architecture enables a slew of benefits that
        traditional DEXs cannot achieve – from gasless trading to MEV protection and surplus.
      </>
    ),
  },
  {
    question: 'What are the official Planet Swap social channels?',
    answer: (
      <>
