...
const GLOBAL_FOOTER_DESCRIPTION =
  'Planet DAO is an open collective of developers, market makers, and community contributors on a mission to protect users from the dangers of DeFi.'
  ...
  return (
    <FooterContainer ref={footerRef} expanded={isFooterExpanded} hasTouchFooter={hasTouchFooter}>
      ...
      <FooterBottom maxWidth={maxWidth}>
        <BottomText>&copy; Planet DAO - {new Date().getFullYear()}</BottomText>
        <FooterBottomLogos>
